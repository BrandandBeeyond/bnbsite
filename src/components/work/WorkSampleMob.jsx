...
const WorkSampleMob = () => {
  return (
    <section className="m-top-minus-50">
      <div className="container-fluid">
        <div className="wrapper">
          <h2 className="work_head text-center py-3">Our work</h2>
          <div className="h-section-mob first">
            <div className="row">
          ...
          <div className="h-section-mob second mt-5">
            <div className="row">
              <div className="col-3 pe-1">
                <div className="row gy-3">
                  <div className="col-lg-12">
                    <div className="card smallcard rounded-3 border-0 bg-beeyond d-flex justify-content-center align-items-center">
                      <img
                        ...
                        className="img-fluid beeyondlogo"
                        alt=""
                      />
                    </div>
                  </div>
          ...
          <div className="h-section-mob fourth mt-5">
            <div className="row">
              <div className="col-3 pe-1">
                <div className="row gy-3">
                  <div className="col-lg-12">
